...
export default function Home() {
  ...
  async function handleSearch(event: FormEvent<HTMLFormElement>) {
    ...
    if (!trimmedQuery) {
      setError("Tell us what kind of property you're looking for.");
      return;
    }
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/90 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          ...
          >
            Rentz<span className="text-blue-500">.</span>
          </Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 pb-20 pt-24 text-center sm:pt-32">
          ...
          <p className="mx-auto mt-7 max-w-2xl text-base leading-8 text-slate-400 sm:text-lg">
            Tell Rentz what you&apos;re looking for in normal
            language. Our intelligence engine understands your
            requirements and ranks the properties that best match.
          </p>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {[
                ...
                <button
                  ...
                  className="rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs text-slate-400 transition hover:border-blue-500/30 hover:bg-blue-500/10 hover:text-blue-400"
                >
                  {example}
                </button>
              ))}
            ...
            <div className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  {results.length} properties ranked for your
                  search.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-3xl px-6 pb-24 text-center">
          <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-10 sm:p-14">
            ...
            <p className="mx-auto mt-3 max-w-lg text-sm leading-7 text-slate-500">
              Describe the property you want in your own words.
              Rentz will understand your requirements and find the
              properties that best match.
            </p>
          </div>
        </section>
      )}
